...
// Dynamic BASE_URL detection for WAMP / XAMPP / Vercel / Live Servers
if (!defined('BASE_URL')) {
...
try {
    ...
    .box{background:#1e293b;border:1px solid rgba(239,68,68,.3);border-radius:16px;padding:40px;text-align:center;max-width:480px;box-shadow:0 10px 25px rgba(0,0,0,0.3);}
    ...
    <p>Cannot connect to the MySQL database. If deployed on Vercel, please ensure your Cloud Database Environment Variables (DB_HOST, DB_USER, DB_PASS, DB_NAME, DB_PORT) are set.</p></div></body></html>
    ');
}
